 ...
 * {@link JobStatusHook} for atomic CTAS. {@link TwoPhaseCatalogTable} will be a member variable of
 * CtasJobStatusHook and can be serialized;
 *
 * <p>CtasJobStatusHook#onCreated will call the beginTransaction method of TwoPhaseCatalogTable;
